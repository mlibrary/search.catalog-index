...
settings do
  provide "solr_writer.basic_auth_user", S.solr_user if S.solr_cloud_on?
  provide "solr_writer.basic_auth_password", S.solr_password if S.solr_cloud_on?
  ...
  provide "processing_thread_pool", S.processing_threads
