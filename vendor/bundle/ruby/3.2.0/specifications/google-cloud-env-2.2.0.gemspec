# -*- encoding: utf-8 -*-
# stub: google-cloud-env 2.2.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/googleapis/ruby-cloud-env/issues", "changelog_uri" => "https://rubydoc.info/gems/google-cloud-env/2.2.0/CHANGELOG.md", "documentation_uri" => "https://rubydoc.info/gems/google-cloud-env/2.2.0", "source_code_uri" => "https://github.com/googleapis/ruby-cloud-env" } if s.respond_to? :metadata=
